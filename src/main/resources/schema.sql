...
(
    film_id  INTEGER
        CONSTRAINT film_genre_film_id_FK REFERENCES films (film_id),
    genre_id INTEGER
...
(
    user_id   INTEGER
        CONSTRAINT user_friends_user_id_FK REFERENCES users (user_id),
    friend_id INTEGER
        CONSTRAINT user_friends_friend_id_FK REFERENCES users (user_id),
    status    INTEGER
...
(
    film_id INTEGER
        CONSTRAINT film_likes_film_id_FK REFERENCES films (film_id),
    user_id INTEGER
        CONSTRAINT film_likes_user_id_FK REFERENCES users (user_id),
