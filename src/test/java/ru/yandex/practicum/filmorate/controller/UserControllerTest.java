...
//        testUser.setBirthday(Instant.from(ZonedDateTime.of(LocalDateTime.of(2010, 10, 10, 0, 0), ZoneId.of("Europe/Moscow"))));
        testUser.setEmail("Ivan@ivan.ru");
    }

    @Test
    void shouldApproveUserWithCorrectData() throws ValidationException {
        assertTrue(userController.checkIsUserDataCorrect(testUser), "Корректная версия User  не прошла проверку");
    }
